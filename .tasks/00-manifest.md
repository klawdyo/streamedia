...
| T75 | `.tasks/75-users-roles-config-migration.md` | Migration SQL: tabelas users, user_roles, configurations | done | spec/admin-unificado.md |
| T76 | `.tasks/76-user-role-config-models.md` | Modelos Go: User, UserRole, Configuration + queries | done | spec/admin-unificado.md — depende T75 |
| T77 | `.tasks/77-config-manager-dbconfig.md` | Pacote config/dbconfig — gerenciador de configs com fallback para defaults | done | spec/admin-unificado.md — depende T75 |
| T78 | `.tasks/78-google-oauth-session.md` | Google OAuth2 — fluxo login/callback + session cookie com user_id e roles | done | spec/admin-unificado.md — depende T76 |
| T79 | `.tasks/79-role-auth-middleware.md` | Middleware RoleAuth — autorização por roles explícitas em cada endpoint | done | spec/admin-unificado.md — depende T76 |
| T80 | `.tasks/80-admin-users-crud-reprocess.md` | CRUD /admin/users com regra de nível + POST /api/videos/{id}/reprocess | done | spec/admin-unificado.md — depende T76, T79 |
| T81 | `.tasks/81-admin-config-api.md` | Config API: GET/PUT/DELETE /admin/config com validação e agrupamento | done | spec/admin-unificado.md — depende T77, T79 |
| T82 | `.tasks/82-server-spa-wire.md` | Wire completo server.go: SPA /app, auth Google, RoleAuth, remoção legado | done | spec/admin-unificado.md — depende T78, T79, T80, T81 |
| T83 | `.tasks/83-vue-vite-scaffold.md` | Scaffold web/: Vite + Vue 3 + TS + Tailwind + shadcn-vue + phosphor-icons | done | spec/admin-unificado.md |
| T84 | `.tasks/84-router-stores-guards-menu.md` | Router meta, Pinia stores, navigation guards, menu composable, api client | done | spec/admin-unificado.md — depende T83 |
| T85 | `.tasks/85-views-login-overview-videos-playground.md` | Views: Login, Overview, Videos, Video, Playground | done | spec/admin-unificado.md — depende T84 |
| T86 | `.tasks/86-views-users-config-components.md` | Views: Users, Config + RolesSelect + ConfigEditor | done | spec/admin-unificado.md — depende T84 |
| T87 | `.tasks/87-docker-multistage-coolify.md` | Dockerfile multi-stage + docker-compose Coolify final | done | spec/admin-unificado.md — depende T82, T85 |
| T88 | `.tasks/88-testes-backend-frontend.md` | Testes Go (auth, roles, users, config) + Vitest (stores, guards, menu) | done | spec/admin-unificado.md — depende T82, T86 |
| T89 | `.tasks/89-remocao-legado.md` | Remoção de legacy: dashboard, playground, docs, POST /admin/session | done | spec/admin-unificado.md — depende T82 |
| T90 | `.tasks/90-atualizar-spec-versioner.md` | Atualizar spec/ + .agents/versioner.md (sync package.json) | done | spec/admin-unificado.md — depende T89 |

## Próxima onda — Admin Unificado Vue.js + Google OAuth (T75-T90)

Ver `spec/admin-unificado.md` para especificação completa.
